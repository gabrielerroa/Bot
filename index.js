...
// CONFIGURAÇÃO ADAPTADA PARA A VERSÃO BETA 26.2
const CONFIG = {
  host: 'Cabosemfio.aternos.me', 
  port: 25565,        // Porta padrão Spigot Java do Aternos
  username: 'BotAntiAFK',
  version: '26.2'     // Texto exato que o seu servidor Spigot Beta está exigindo
};

let bot;

function criarBot() {
  console.log('🤖 Conectando ao Spigot Beta na versão 26.2...');
